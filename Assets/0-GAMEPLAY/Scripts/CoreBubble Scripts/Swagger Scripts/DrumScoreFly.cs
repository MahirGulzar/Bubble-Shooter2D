...
public class DrumScoreFly : MonoBehaviour {
    ...
    void OnEnable()
    {
        ...
        iTween.MoveBy(this.gameObject, iTween.Hash("x", randx, "y", rand, "speed", 3f, "easetype", iTween.EaseType.linear, "ignoretimescale", true));
